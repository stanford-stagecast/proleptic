...
public:
   ...
   *
   * @note  The network in the file has to match the network structure currently expected by libsimplenn, which
   ...
   *
   * @param[in] past_timestamps A list of previous note timestamps, starting from the most recent (the lowest value)
   * and going up to the 16th most recent.  The values should be in seconds relative to the time when this function
   * is called, where positive values are in the past and negative values are in the future.
   *
