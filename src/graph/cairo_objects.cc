...
void Cairo::Context::Deleter::operator()(cairo_t *x) const { cairo_destroy(x); }

void Cairo::Pattern::Deleter::operator()(cairo_pattern_t *x) const { cairo_pattern_destroy(x); }

void Pango::Font::Deleter::operator()(PangoFontDescription *x) const { pango_font_description_free(x); }

void Pango::Text::Deleter::operator()(cairo_path_t *x) const { cairo_path_destroy(x); }
...
Pango::Pango(Cairo &cairo) : context_(pango_cairo_create_context(cairo)), layout_(pango_layout_new(*this)) {}

Pango::Font::Font(const string &description) : font(pango_font_description_from_string(description.c_str())) {}

void Pango::set_font(const Pango::Font &font) { pango_layout_set_font_description(*this, font); }
...
Pango::Text::Text(Cairo &cairo, Pango &pango, const Font &font, const string &text) : path_(), extent_({0, 0, 0, 0}) {
...
Cairo::Pattern::Pattern(cairo_pattern_t *pattern) : pattern_(pattern) {
